...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/vehicle_event_flags.hpp"
...
inline void to_flow_style_yaml(
  const VehicleEventFlags & msg,
  std::ostream & out)
{
  out << "{";
  // member: vehicle_event_flag
  {
    out << "vehicle_event_flag: ";
    rosidl_generator_traits::value_to_yaml(msg.vehicle_event_flag, out);
  }
  out << "}";
...
inline std::string to_yaml(const VehicleEventFlags & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::VehicleEventFlags & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::VehicleEventFlags & msg)
{
