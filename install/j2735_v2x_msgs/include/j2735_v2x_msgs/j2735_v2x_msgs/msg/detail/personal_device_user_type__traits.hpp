...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/personal_device_user_type.hpp"
...
inline void to_flow_style_yaml(
  const PersonalDeviceUserType & msg,
  std::ostream & out)
{
  out << "{";
  // member: type
...
inline std::string to_yaml(const PersonalDeviceUserType & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::PersonalDeviceUserType & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::PersonalDeviceUserType & msg)
{
