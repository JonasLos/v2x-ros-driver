...
j2735_v2x_msgs__msg__NodeXY__get_type_hash(
...
static char j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__delta[] = "delta";
static char j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__attributes[] = "attributes";
static char j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__attributes_exists[] = "attributes_exists";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__NodeXY__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__delta, 5, 5},
    {
  ...
  {
    {j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__attributes, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {j2735_v2x_msgs__msg__NodeXY__FIELD_NAME__attributes_exists, 17, 17},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__NodeXY__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
j2735_v2x_msgs__msg__NodeXY__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__NodeXY__FIELDS, 3, 3},
    },
    {j2735_v2x_msgs__msg__NodeXY__REFERENCED_TYPE_DESCRIPTIONS, 18, 18},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[7].fields = j2735_v2x_msgs__msg__NodeXY20b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = j2735_v2x_msgs__msg__NodeXY22b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = j2735_v2x_msgs__msg__NodeXY24b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = j2735_v2x_msgs__msg__NodeXY26b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[11].fields = j2735_v2x_msgs__msg__NodeXY28b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[12].fields = j2735_v2x_msgs__msg__NodeXY32b__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[13].fields = j2735_v2x_msgs__msg__RegulatorySpeedLimit__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[14].fields = j2735_v2x_msgs__msg__SegmentAttributeXY__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[15].fields = j2735_v2x_msgs__msg__SegmentAttributeXYList__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[16].fields = j2735_v2x_msgs__msg__SpeedLimitList__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[17].fields = j2735_v2x_msgs__msg__SpeedLimitType__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "# }\n"
  "\n"
  "j2735_v2x_msgs/NodeOffsetPointXY delta\n"
  "\n"
  "j2735_v2x_msgs/NodeAttributeSetXY attributes\n"
...
j2735_v2x_msgs__msg__NodeXY__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {j2735_v2x_msgs__msg__NodeXY__TYPE_NAME, 25, 25},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 790, 790},
  };
  return &source;
}

const rosidl_runtime_c__type_description__TypeSource__Sequence *
j2735_v2x_msgs__msg__NodeXY__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__NodeXY__get_individual_type_description_source(NULL),
    ...
    sources[8] = *j2735_v2x_msgs__msg__NodeXY20b__get_individual_type_description_source(NULL);
    sources[9] = *j2735_v2x_msgs__msg__NodeXY22b__get_individual_type_description_source(NULL);
    sources[10] = *j2735_v2x_msgs__msg__NodeXY24b__get_individual_type_description_source(NULL);
    sources[11] = *j2735_v2x_msgs__msg__NodeXY26b__get_individual_type_description_source(NULL);
    sources[12] = *j2735_v2x_msgs__msg__NodeXY28b__get_individual_type_description_source(NULL);
    sources[13] = *j2735_v2x_msgs__msg__NodeXY32b__get_individual_type_description_source(NULL);
    sources[14] = *j2735_v2x_msgs__msg__RegulatorySpeedLimit__get_individual_type_description_source(NULL);
    sources[15] = *j2735_v2x_msgs__msg__SegmentAttributeXY__get_individual_type_description_source(NULL);
    sources[16] = *j2735_v2x_msgs__msg__SegmentAttributeXYList__get_individual_type_description_source(NULL);
    sources[17] = *j2735_v2x_msgs__msg__SpeedLimitList__get_individual_type_description_source(NULL);
    sources[18] = *j2735_v2x_msgs__msg__SpeedLimitType__get_individual_type_description_source(NULL);
    constructed = true;
  }
