...
{
  new (message_memory) j2735_v2x_msgs::msg::RestrictionClassAssignment(_init);
}

void RestrictionClassAssignment_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::RestrictionClassAssignment *>(message_memory);
  typed_message->~RestrictionClassAssignment();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RestrictionClassAssignment_message_member_array[1] = {
  {
    "id",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::RestrictionClassAssignment, id),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RestrictionClassAssignment_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::RestrictionClassAssignment),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::RestrictionClassAssignment>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::RestrictionClassAssignment_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, RestrictionClassAssignment)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::RestrictionClassAssignment_message_type_support_handle;
}
