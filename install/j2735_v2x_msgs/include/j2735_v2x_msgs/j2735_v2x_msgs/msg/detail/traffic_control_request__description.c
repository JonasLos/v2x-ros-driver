  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x3c, 0xf1, 0xa7, 0x83, 0xf9, 0x3b, 0x6d, 0x78,
      0x93, 0xc5, 0x61, 0xe7, 0xb4, 0xb2, 0x18, 0x7c,
      0xd5, 0x04, 0x8e, 0x2d, 0xe5, 0xc4, 0xdc, 0xb7,
      0x5c, 0xb2, 0x54, 0x09, 0xce, 0x76, 0xc6, 0x59,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t j2735_v2x_msgs__msg__TrafficControlRequestV01__EXPECTED_HASH = {1, {
...
static char j2735_v2x_msgs__msg__TrafficControlRequest__TYPE_NAME[] = "j2735_v2x_msgs/msg/TrafficControlRequest";
...
static char j2735_v2x_msgs__msg__TrafficControlRequest__FIELD_NAME__choice[] = "choice";
static char j2735_v2x_msgs__msg__TrafficControlRequest__FIELD_NAME__tcr_v01[] = "tcr_v01";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__TrafficControlRequest__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__TrafficControlRequest__FIELD_NAME__choice, 6, 6},
    {
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlRequest__FIELD_NAME__tcr_v01, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__TrafficControlRequest__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {j2735_v2x_msgs__msg__TrafficControlRequest__TYPE_NAME, 40, 40},
      {j2735_v2x_msgs__msg__TrafficControlRequest__FIELDS, 2, 2},
    },
    {j2735_v2x_msgs__msg__TrafficControlRequest__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&j2735_v2x_msgs__msg__TrafficControlRequestV01__EXPECTED_HASH, j2735_v2x_msgs__msg__TrafficControlRequestV01__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[3].fields = j2735_v2x_msgs__msg__TrafficControlRequestV01__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "j2735_v2x_msgs/TrafficControlRequestV01 tcr_v01";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__TrafficControlRequest__get_individual_type_description_source(NULL),
    ...
    sources[4] = *j2735_v2x_msgs__msg__TrafficControlRequestV01__get_individual_type_description_source(NULL);
    constructed = true;
  }
