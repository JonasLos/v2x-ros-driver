...
void fetch_function__TrailerHistoryPointList__trailer_history_points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const j2735_v2x_msgs::msg::TrailerHistoryPoint *>(
    get_const_function__TrailerHistoryPointList__trailer_history_points(untyped_member, index));
  auto & value = *reinterpret_cast<j2735_v2x_msgs::msg::TrailerHistoryPoint *>(untyped_value);
  value = item;
}

void assign_function__TrailerHistoryPointList__trailer_history_points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<j2735_v2x_msgs::msg::TrailerHistoryPoint *>(
    get_function__TrailerHistoryPointList__trailer_history_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const j2735_v2x_msgs::msg::TrailerHistoryPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrailerHistoryPointList_message_member_array[1] = {
  {
    ...
    fetch_function__TrailerHistoryPointList__trailer_history_points,  // fetch(index, &value) function pointer
    assign_function__TrailerHistoryPointList__trailer_history_points,  // assign(index, value) function pointer
