...
{
  new (message_memory) j2735_v2x_msgs::msg::Heading(_init);
}

void Heading_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::Heading *>(message_memory);
  typed_message->~Heading();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Heading_message_member_array[1] = {
  {
    "heading",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::Heading, heading),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heading_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::Heading),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::Heading>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Heading_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, Heading)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Heading_message_type_support_handle;
}
