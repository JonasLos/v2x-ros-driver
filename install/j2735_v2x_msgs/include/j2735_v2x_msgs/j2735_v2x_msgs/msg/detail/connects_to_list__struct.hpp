...
struct ConnectsToList_
{
  ...
  using _connect_to_list_type =
    std::vector<j2735_v2x_msgs::msg::Connection_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<j2735_v2x_msgs::msg::Connection_<ContainerAllocator>>>;
  _connect_to_list_type connect_to_list;

  // setters for named parameter idiom
  Type & set__connect_to_list(
    const std::vector<j2735_v2x_msgs::msg::Connection_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<j2735_v2x_msgs::msg::Connection_<ContainerAllocator>>> & _arg)
  {
