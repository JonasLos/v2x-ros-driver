...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/intersection_status_object.hpp"
  ...
  std::ostream & out)
{
  ...
  {
    out << "intersection_status_object: ";
    rosidl_generator_traits::value_to_yaml(msg.intersection_status_object, out);
  }
  out << "}";
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::IntersectionStatusObject & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::IntersectionStatusObject & msg)
{
