...
{
  new (message_memory) j2735_v2x_msgs::msg::OffsetB11(_init);
}

void OffsetB11_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::OffsetB11 *>(message_memory);
  typed_message->~OffsetB11();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember OffsetB11_message_member_array[1] = {
  {
    "offset",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::OffsetB11, offset),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OffsetB11_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::OffsetB11),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::OffsetB11>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::OffsetB11_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, OffsetB11)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::OffsetB11_message_type_support_handle;
}
