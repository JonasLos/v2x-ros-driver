  ...
  std::ostream & out)
{
  ...
  {
    out << "millisecond: ";
    rosidl_generator_traits::value_to_yaml(msg.millisecond, out);
  }
  out << "}";
...
inline std::string to_yaml(const DSecond & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::DSecond & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::DSecond & msg)
{
