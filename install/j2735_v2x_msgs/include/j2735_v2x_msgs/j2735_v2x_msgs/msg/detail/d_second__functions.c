  ...
  j2735_v2x_msgs__msg__DSecond * output)
{
  ...
  // millisecond
  output->millisecond = input->millisecond;
  return true;
}

j2735_v2x_msgs__msg__DSecond *
j2735_v2x_msgs__msg__DSecond__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  j2735_v2x_msgs__msg__DSecond * msg = (j2735_v2x_msgs__msg__DSecond *)allocator.allocate(sizeof(j2735_v2x_msgs__msg__DSecond), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(j2735_v2x_msgs__msg__DSecond));
  bool success = j2735_v2x_msgs__msg__DSecond__init(msg);
  if (!success) {
...
j2735_v2x_msgs__msg__DSecond__destroy(j2735_v2x_msgs__msg__DSecond * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    j2735_v2x_msgs__msg__DSecond__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
j2735_v2x_msgs__msg__DSecond__Sequence__init(j2735_v2x_msgs__msg__DSecond__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  j2735_v2x_msgs__msg__DSecond * data = NULL;

  if (size) {
    data = (j2735_v2x_msgs__msg__DSecond *)allocator.zero_allocate(size, sizeof(j2735_v2x_msgs__msg__DSecond), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = j2735_v2x_msgs__msg__DSecond__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        j2735_v2x_msgs__msg__DSecond__fini(&data[i - 1]);
      }
...
j2735_v2x_msgs__msg__DSecond__Sequence__fini(j2735_v2x_msgs__msg__DSecond__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      j2735_v2x_msgs__msg__DSecond__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  j2735_v2x_msgs__msg__DSecond__Sequence * array = (j2735_v2x_msgs__msg__DSecond__Sequence *)allocator.allocate(sizeof(j2735_v2x_msgs__msg__DSecond__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = j2735_v2x_msgs__msg__DSecond__Sequence__init(array, size);
  if (!success) {
...
j2735_v2x_msgs__msg__DSecond__Sequence__destroy(j2735_v2x_msgs__msg__DSecond__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    j2735_v2x_msgs__msg__DSecond__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
j2735_v2x_msgs__msg__DSecond__Sequence__are_equal(const j2735_v2x_msgs__msg__DSecond__Sequence * lhs, const j2735_v2x_msgs__msg__DSecond__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!j2735_v2x_msgs__msg__DSecond__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  j2735_v2x_msgs__msg__DSecond__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(j2735_v2x_msgs__msg__DSecond);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    j2735_v2x_msgs__msg__DSecond * data =
      (j2735_v2x_msgs__msg__DSecond *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!j2735_v2x_msgs__msg__DSecond__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          j2735_v2x_msgs__msg__DSecond__fini(&output->data[i]);
        }
        return false;
      }
    }
