...
inline std::string to_yaml(const GetLights_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const carma_driver_msgs::srv::GetLights_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const carma_driver_msgs::srv::GetLights_Request & msg)
{
...
inline std::string to_yaml(const GetLights_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use carma_driver_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const carma_driver_msgs::srv::GetLights_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  carma_driver_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use carma_driver_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const carma_driver_msgs::srv::GetLights_Response & msg)
{
  return carma_driver_msgs::srv::to_yaml(msg);
}
...
inline std::string to_yaml(const GetLights_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use carma_driver_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const carma_driver_msgs::srv::GetLights_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  carma_driver_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use carma_driver_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const carma_driver_msgs::srv::GetLights_Event & msg)
{
  return carma_driver_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<carma_driver_msgs::srv::GetLights_Event>()
{
  return "carma_driver_msgs::srv::GetLights_Event";
}

template<>
inline const char * name<carma_driver_msgs::srv::GetLights_Event>()
{
  return "carma_driver_msgs/srv/GetLights_Event";
}

template<>
struct has_fixed_size<carma_driver_msgs::srv::GetLights_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<carma_driver_msgs::srv::GetLights_Event>
  : std::integral_constant<bool, has_bounded_size<carma_driver_msgs::srv::GetLights_Request>::value && has_bounded_size<carma_driver_msgs::srv::GetLights_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<carma_driver_msgs::srv::GetLights_Event>
  : std::true_type {};
