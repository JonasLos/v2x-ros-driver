...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/privileged_event_flags.hpp"
...
inline void to_flow_style_yaml(
  const PrivilegedEventFlags & msg,
  std::ostream & out)
{
  out << "{";
  // member: privileged_event_flags
  {
    out << "privileged_event_flags: ";
    rosidl_generator_traits::value_to_yaml(msg.privileged_event_flags, out);
  }
  out << "}";
...
inline std::string to_yaml(const PrivilegedEventFlags & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::PrivilegedEventFlags & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::PrivilegedEventFlags & msg)
{
