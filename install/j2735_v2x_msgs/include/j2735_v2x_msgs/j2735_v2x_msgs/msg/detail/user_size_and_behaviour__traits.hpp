...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/user_size_and_behaviour.hpp"
...
inline void to_flow_style_yaml(
  const UserSizeAndBehaviour & msg,
  std::ostream & out)
{
  out << "{";
  // member: sizes_and_behaviors
  {
    out << "sizes_and_behaviors: ";
    rosidl_generator_traits::value_to_yaml(msg.sizes_and_behaviors, out);
  }
  out << "}";
...
inline std::string to_yaml(const UserSizeAndBehaviour & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::UserSizeAndBehaviour & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::UserSizeAndBehaviour & msg)
{
