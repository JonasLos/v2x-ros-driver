...
{
  new (message_memory) j2735_v2x_msgs::msg::Velocity(_init);
}

void Velocity_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::Velocity *>(message_memory);
  typed_message->~Velocity();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Velocity_message_member_array[1] = {
  {
    "velocity",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::Velocity, velocity),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Velocity_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::Velocity),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::Velocity>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, Velocity)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
