  ...
  std::ostream & out)
{
  ...
  {
    out << "trailer_weight: ";
    rosidl_generator_traits::value_to_yaml(msg.trailer_weight, out);
  }
  out << "}";
...
inline std::string to_yaml(const TrailerWeight & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::TrailerWeight & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::TrailerWeight & msg)
{
