...
{
  new (message_memory) j2735_v2x_msgs::msg::AmbientAirPressure(_init);
}

void AmbientAirPressure_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::AmbientAirPressure *>(message_memory);
  typed_message->~AmbientAirPressure();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember AmbientAirPressure_message_member_array[1] = {
  {
    "pressure",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::AmbientAirPressure, pressure),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AmbientAirPressure_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::AmbientAirPressure),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::AmbientAirPressure>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::AmbientAirPressure_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, AmbientAirPressure)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::AmbientAirPressure_message_type_support_handle;
}
