...
#ifndef CARMA_DRIVER_MSGS__MSG__DETAIL__TRAILER_ANGLE__TYPE_SUPPORT_H_
#define CARMA_DRIVER_MSGS__MSG__DETAIL__TRAILER_ANGLE__TYPE_SUPPORT_H_
...
#endif  // CARMA_DRIVER_MSGS__MSG__DETAIL__TRAILER_ANGLE__TYPE_SUPPORT_H_
