...
void carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_init_function(
...
void carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_fini_function(void * message_memory)
{
  carma_msgs__msg__LightBarIndicatorControllers__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_member_array[8] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_members = {
  ...
  carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_member_array,  // message members
  carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_init_function,  // function to initialize message memory (memory has to be allocated)
  carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_type_support_handle = {
  0,
  &carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_msgs, msg, LightBarIndicatorControllers)() {
  if (!carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_type_support_handle.typesupport_identifier) {
    carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &carma_msgs__msg__LightBarIndicatorControllers__rosidl_typesupport_introspection_c__LightBarIndicatorControllers_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
