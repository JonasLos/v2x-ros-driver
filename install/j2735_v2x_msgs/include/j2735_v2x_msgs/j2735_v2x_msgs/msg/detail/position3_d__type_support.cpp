...
{
  new (message_memory) j2735_v2x_msgs::msg::Position3D(_init);
}

void Position3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::Position3D *>(message_memory);
  typed_message->~Position3D();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Position3D_message_member_array[4] = {
  {
    "latitude",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::Position3D, latitude),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::Position3D, longitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::Position3D, elevation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::Position3D, elevation_exists),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position3D_message_members = {
  ...
  4,  // number of fields
  sizeof(j2735_v2x_msgs::msg::Position3D),
...
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Position3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, Position3D)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Position3D_message_type_support_handle;
}
