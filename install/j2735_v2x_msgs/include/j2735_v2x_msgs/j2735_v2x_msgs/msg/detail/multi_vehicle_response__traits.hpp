...
inline void to_flow_style_yaml(
  const MultiVehicleResponse & msg,
  std::ostream & out)
{
  out << "{";
  // member: multi_vehicle_response
  {
    out << "multi_vehicle_response: ";
    rosidl_generator_traits::value_to_yaml(msg.multi_vehicle_response, out);
  }
  out << "}";
...
inline std::string to_yaml(const MultiVehicleResponse & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::MultiVehicleResponse & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::MultiVehicleResponse & msg)
{
