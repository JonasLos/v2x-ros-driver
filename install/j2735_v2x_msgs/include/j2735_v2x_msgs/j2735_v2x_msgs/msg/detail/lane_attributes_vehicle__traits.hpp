...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/lane_attributes_vehicle.hpp"
...
inline void to_flow_style_yaml(
  const LaneAttributesVehicle & msg,
  std::ostream & out)
{
  out << "{";
  // member: lane_attributes_vehicle
  {
    out << "lane_attributes_vehicle: ";
    rosidl_generator_traits::value_to_yaml(msg.lane_attributes_vehicle, out);
  }
  out << "}";
...
inline std::string to_yaml(const LaneAttributesVehicle & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::LaneAttributesVehicle & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::LaneAttributesVehicle & msg)
{
