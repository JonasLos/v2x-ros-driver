...
{
  new (message_memory) j2735_v2x_msgs::msg::WiperSet(_init);
}

void WiperSet_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::WiperSet *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WiperSet_message_member_array[5] = {
  {
    ...
    offsetof(j2735_v2x_msgs::msg::WiperSet, presence_vector),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::WiperSet, status_front),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<j2735_v2x_msgs::msg::WiperRate>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::WiperSet, rate_front),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::WiperSet, status_rear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::WiperSet, rate_rear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WiperSet_message_members = {
  ...
  5,  // number of fields
  sizeof(j2735_v2x_msgs::msg::WiperSet),
...
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::WiperSet_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, WiperSet)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::WiperSet_message_type_support_handle;
}
