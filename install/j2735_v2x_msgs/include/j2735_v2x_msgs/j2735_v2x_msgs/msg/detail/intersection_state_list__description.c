...
static char j2735_v2x_msgs__msg__IntersectionStateList__FIELD_NAME__intersection_state_list[] = "intersection_state_list";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__IntersectionStateList__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__IntersectionStateList__FIELD_NAME__intersection_state_list, 23, 23},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__IntersectionStateList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__IntersectionStateList__FIELDS, 1, 1},
    },
    {j2735_v2x_msgs__msg__IntersectionStateList__REFERENCED_TYPE_DESCRIPTIONS, 16, 16},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[7].fields = j2735_v2x_msgs__msg__IntersectionStatusObject__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = j2735_v2x_msgs__msg__ManeuverAssistList__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = j2735_v2x_msgs__msg__MovementEvent__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = j2735_v2x_msgs__msg__MovementEventList__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[11].fields = j2735_v2x_msgs__msg__MovementList__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[12].fields = j2735_v2x_msgs__msg__MovementPhaseState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[13].fields = j2735_v2x_msgs__msg__MovementState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[14].fields = j2735_v2x_msgs__msg__SpeedConfidence__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[15].fields = j2735_v2x_msgs__msg__TimeChangeDetails__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "j2735_v2x_msgs/IntersectionState[] intersection_state_list";
...
j2735_v2x_msgs__msg__IntersectionStateList__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__IntersectionStateList__get_individual_type_description_source(NULL),
    ...
    sources[8] = *j2735_v2x_msgs__msg__IntersectionStatusObject__get_individual_type_description_source(NULL);
    sources[9] = *j2735_v2x_msgs__msg__ManeuverAssistList__get_individual_type_description_source(NULL);
    sources[10] = *j2735_v2x_msgs__msg__MovementEvent__get_individual_type_description_source(NULL);
    sources[11] = *j2735_v2x_msgs__msg__MovementEventList__get_individual_type_description_source(NULL);
    sources[12] = *j2735_v2x_msgs__msg__MovementList__get_individual_type_description_source(NULL);
    sources[13] = *j2735_v2x_msgs__msg__MovementPhaseState__get_individual_type_description_source(NULL);
    sources[14] = *j2735_v2x_msgs__msg__MovementState__get_individual_type_description_source(NULL);
    sources[15] = *j2735_v2x_msgs__msg__SpeedConfidence__get_individual_type_description_source(NULL);
    sources[16] = *j2735_v2x_msgs__msg__TimeChangeDetails__get_individual_type_description_source(NULL);
    constructed = true;
  }
