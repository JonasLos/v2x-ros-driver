...
enum
{
  carma_driver_msgs__srv__GetDriverStatus_Event__request__MAX_SIZE = 1
};
// response
enum
{
  carma_driver_msgs__srv__GetDriverStatus_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetDriverStatus in the package carma_driver_msgs.
typedef struct carma_driver_msgs__srv__GetDriverStatus_Event
{
  service_msgs__msg__ServiceEventInfo info;
  carma_driver_msgs__srv__GetDriverStatus_Request__Sequence request;
  carma_driver_msgs__srv__GetDriverStatus_Response__Sequence response;
} carma_driver_msgs__srv__GetDriverStatus_Event;

// Struct for a sequence of carma_driver_msgs__srv__GetDriverStatus_Event.
typedef struct carma_driver_msgs__srv__GetDriverStatus_Event__Sequence
{
