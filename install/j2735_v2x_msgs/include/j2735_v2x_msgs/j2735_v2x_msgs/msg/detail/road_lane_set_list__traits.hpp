...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/road_lane_set_list.hpp"
...
inline void to_flow_style_yaml(
  const RoadLaneSetList & msg,
  std::ostream & out)
{
  out << "{";
  // member: road_lane_set_list
  {
    if (msg.road_lane_set_list.size() == 0) {
      out << "road_lane_set_list: []";
    } else {
      out << "road_lane_set_list: [";
      size_t pending_items = msg.road_lane_set_list.size();
      for (auto item : msg.road_lane_set_list) {
...
inline std::string to_yaml(const RoadLaneSetList & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::RoadLaneSetList & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::RoadLaneSetList & msg)
{
