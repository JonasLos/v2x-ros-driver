...
void fetch_function__EnabledLaneList__lane_id_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__EnabledLaneList__lane_id_list(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__EnabledLaneList__lane_id_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__EnabledLaneList__lane_id_list(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EnabledLaneList_message_member_array[1] = {
  {
    ...
    fetch_function__EnabledLaneList__lane_id_list,  // fetch(index, &value) function pointer
    assign_function__EnabledLaneList__lane_id_list,  // assign(index, value) function pointer
