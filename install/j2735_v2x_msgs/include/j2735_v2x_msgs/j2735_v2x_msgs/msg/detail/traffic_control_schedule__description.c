...
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__start[] = "start";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__end[] = "end";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__end_exists[] = "end_exists";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__dow[] = "dow";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__dow_exists[] = "dow_exists";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__between[] = "between";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__between_exists[] = "between_exists";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__repeat[] = "repeat";
static char j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__repeat_exists[] = "repeat_exists";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__TrafficControlSchedule__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__start, 5, 5},
    {
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__end, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT64,
      0,
      0,
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__end_exists, 10, 10},
    {
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__dow, 3, 3},
    {
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__dow_exists, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__between, 7, 7},
    {
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__between_exists, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__repeat, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELD_NAME__repeat_exists, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__TrafficControlSchedule__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {j2735_v2x_msgs__msg__DailySchedule__TYPE_NAME, 32, 32},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__TrafficControlSchedule__FIELDS, 9, 9},
    },
    {j2735_v2x_msgs__msg__TrafficControlSchedule__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "# between [2] SEQUENCE (SIZE(1..63)) OF DailySchedule OPTIONAL, \n"
  "j2735_v2x_msgs/DailySchedule[] between\n"
  "bool between_exists\n"
  "\n"
  "# repeat [3] RepeatParams OPTIONAL\n"
  "j2735_v2x_msgs/RepeatParams repeat\n"
  "bool repeat_exists";
...
j2735_v2x_msgs__msg__TrafficControlSchedule__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__TrafficControlSchedule__get_individual_type_description_source(NULL),
