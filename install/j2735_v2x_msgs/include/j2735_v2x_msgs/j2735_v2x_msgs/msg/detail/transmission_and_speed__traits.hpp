...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/transmission_and_speed.hpp"
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::TransmissionAndSpeed & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::TransmissionAndSpeed & msg)
{
