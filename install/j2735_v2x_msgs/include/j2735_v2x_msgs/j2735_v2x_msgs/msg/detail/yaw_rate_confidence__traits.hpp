...
inline void to_flow_style_yaml(
  const YawRateConfidence & msg,
  std::ostream & out)
{
  out << "{";
  // member: yaw_rate_confidence
  {
    out << "yaw_rate_confidence: ";
    rosidl_generator_traits::value_to_yaml(msg.yaw_rate_confidence, out);
  }
  out << "}";
...
inline std::string to_yaml(const YawRateConfidence & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::YawRateConfidence & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::YawRateConfidence & msg)
{
