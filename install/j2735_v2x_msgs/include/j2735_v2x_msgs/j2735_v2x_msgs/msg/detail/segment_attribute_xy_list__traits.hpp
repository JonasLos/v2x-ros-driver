...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/segment_attribute_xy_list.hpp"
...
#include "j2735_v2x_msgs/msg/detail/segment_attribute_xy__traits.hpp"
...
inline void to_flow_style_yaml(
  const SegmentAttributeXYList & msg,
  std::ostream & out)
{
  out << "{";
  // member: segment_attribute_xy
  {
    if (msg.segment_attribute_xy.size() == 0) {
      out << "segment_attribute_xy: []";
    } else {
      out << "segment_attribute_xy: [";
      size_t pending_items = msg.segment_attribute_xy.size();
      for (auto item : msg.segment_attribute_xy) {
...
inline std::string to_yaml(const SegmentAttributeXYList & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::SegmentAttributeXYList & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::SegmentAttributeXYList & msg)
{
