...
static char j2735_v2x_msgs__msg__RoadLaneSetList__FIELD_NAME__road_lane_set_list[] = "road_lane_set_list";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__RoadLaneSetList__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__RoadLaneSetList__FIELD_NAME__road_lane_set_list, 18, 18},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__RoadLaneSetList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__RoadLaneSetList__FIELDS, 1, 1},
    },
    {j2735_v2x_msgs__msg__RoadLaneSetList__REFERENCED_TYPE_DESCRIPTIONS, 43, 43},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "j2735_v2x_msgs/GenericLane[] road_lane_set_list";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__RoadLaneSetList__get_individual_type_description_source(NULL),
