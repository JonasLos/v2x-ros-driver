...
{
  new (message_memory) j2735_v2x_msgs::msg::Speed(_init);
}

void Speed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::Speed *>(message_memory);
  typed_message->~Speed();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Speed_message_member_array[1] = {
  {
    ...
    offsetof(j2735_v2x_msgs::msg::Speed, speed),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Speed_message_members = {
  ...
  "Speed",  // message name
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::Speed),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::Speed>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, Speed)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
