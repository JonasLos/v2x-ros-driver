...
class Init_ReleaseIndicatorControl_Event_response
{
public:
  explicit Init_ReleaseIndicatorControl_Event_response(::carma_msgs::srv::ReleaseIndicatorControl_Event & msg)
  : msg_(msg)
  {}
  ::carma_msgs::srv::ReleaseIndicatorControl_Event response(::carma_msgs::srv::ReleaseIndicatorControl_Event::_response_type arg)
  {
...
private:
  ::carma_msgs::srv::ReleaseIndicatorControl_Event msg_;
};

class Init_ReleaseIndicatorControl_Event_request
{
public:
  explicit Init_ReleaseIndicatorControl_Event_request(::carma_msgs::srv::ReleaseIndicatorControl_Event & msg)
  : msg_(msg)
  {}
  Init_ReleaseIndicatorControl_Event_response request(::carma_msgs::srv::ReleaseIndicatorControl_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ReleaseIndicatorControl_Event_response(msg_);
  }
...
class Init_ReleaseIndicatorControl_Event_info
{
public:
  Init_ReleaseIndicatorControl_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ReleaseIndicatorControl_Event_request info(::carma_msgs::srv::ReleaseIndicatorControl_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ReleaseIndicatorControl_Event_request(msg_);
  }
...
template<>
inline
auto build<::carma_msgs::srv::ReleaseIndicatorControl_Event>()
{
  return carma_msgs::srv::builder::Init_ReleaseIndicatorControl_Event_info();
}
