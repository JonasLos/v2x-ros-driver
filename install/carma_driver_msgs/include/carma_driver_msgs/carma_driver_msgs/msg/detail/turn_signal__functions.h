...
// IWYU pragma: private, include "carma_driver_msgs/msg/turn_signal.h"


#ifndef CARMA_DRIVER_MSGS__MSG__DETAIL__TURN_SIGNAL__FUNCTIONS_H_
#define CARMA_DRIVER_MSGS__MSG__DETAIL__TURN_SIGNAL__FUNCTIONS_H_
 ...
 * calls
 * carma_driver_msgs__msg__TurnSignal__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_carma_driver_msgs
carma_driver_msgs__msg__TurnSignal *
carma_driver_msgs__msg__TurnSignal__create(void);

/// Destroy msg/TurnSignal message.
/**
 * It calls
 * carma_driver_msgs__msg__TurnSignal__fini()
 ...
 * carma_driver_msgs__msg__TurnSignal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * carma_driver_msgs__msg__TurnSignal__Sequence__fini()
 * on the array,
...
#endif  // CARMA_DRIVER_MSGS__MSG__DETAIL__TURN_SIGNAL__FUNCTIONS_H_
