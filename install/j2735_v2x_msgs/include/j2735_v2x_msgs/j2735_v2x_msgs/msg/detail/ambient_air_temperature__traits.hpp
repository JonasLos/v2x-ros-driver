...
inline void to_flow_style_yaml(
  const AmbientAirTemperature & msg,
  std::ostream & out)
{
  out << "{";
  // member: temperature
...
inline std::string to_yaml(const AmbientAirTemperature & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::AmbientAirTemperature & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::AmbientAirTemperature & msg)
{
