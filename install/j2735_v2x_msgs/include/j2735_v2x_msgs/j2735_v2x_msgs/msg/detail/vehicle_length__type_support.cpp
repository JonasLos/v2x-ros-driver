...
{
  new (message_memory) j2735_v2x_msgs::msg::VehicleLength(_init);
}

void VehicleLength_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::VehicleLength *>(message_memory);
  typed_message->~VehicleLength();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleLength_message_member_array[1] = {
  {
    "vehicle_length",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::VehicleLength, vehicle_length),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleLength_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::VehicleLength),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::VehicleLength>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleLength_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, VehicleLength)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleLength_message_type_support_handle;
}
