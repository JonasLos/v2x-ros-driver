...
#ifndef CARMA_MSGS__MSG__DETAIL__UI_INSTRUCTIONS__TYPE_SUPPORT_H_
#define CARMA_MSGS__MSG__DETAIL__UI_INSTRUCTIONS__TYPE_SUPPORT_H_
...
#endif  // CARMA_MSGS__MSG__DETAIL__UI_INSTRUCTIONS__TYPE_SUPPORT_H_
