...
{
  new (message_memory) j2735_v2x_msgs::msg::ByteArray(_init);
}

void ByteArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::ByteArray *>(message_memory);
...
void fetch_function__ByteArray__content(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__ByteArray__content(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__ByteArray__content(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__ByteArray__content(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ByteArray_message_member_array[3] = {
  {
    ...
    offsetof(j2735_v2x_msgs::msg::ByteArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::ByteArray, message_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j2735_v2x_msgs::msg::ByteArray, content),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__ByteArray__content,  // fetch(index, &value) function pointer
    assign_function__ByteArray__content,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ByteArray_message_members = {
  ...
  3,  // number of fields
  sizeof(j2735_v2x_msgs::msg::ByteArray),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::ByteArray>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::ByteArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, ByteArray)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::ByteArray_message_type_support_handle;
}
