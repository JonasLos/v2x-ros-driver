...
{
  new (message_memory) j2735_v2x_msgs::msg::Angle(_init);
}

void Angle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::Angle *>(message_memory);
  typed_message->~Angle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Angle_message_member_array[1] = {
  {
    "angle",  // name
    ...
    offsetof(j2735_v2x_msgs::msg::Angle, angle),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Angle_message_members = {
  ...
  "Angle",  // message name
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::Angle),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::Angle>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, Angle)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
