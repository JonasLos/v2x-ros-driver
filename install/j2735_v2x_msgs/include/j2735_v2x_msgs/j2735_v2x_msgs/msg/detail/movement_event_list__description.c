...
static char j2735_v2x_msgs__msg__MovementEventList__FIELD_NAME__movement_event_list[] = "movement_event_list";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__MovementEventList__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__MovementEventList__FIELD_NAME__movement_event_list, 19, 19},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__MovementEventList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__MovementEventList__FIELDS, 1, 1},
    },
    {j2735_v2x_msgs__msg__MovementEventList__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = j2735_v2x_msgs__msg__MovementEvent__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = j2735_v2x_msgs__msg__MovementPhaseState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = j2735_v2x_msgs__msg__SpeedConfidence__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = j2735_v2x_msgs__msg__TimeChangeDetails__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "#\n"
  "\n"
  "j2735_v2x_msgs/MovementEvent[] movement_event_list";
...
j2735_v2x_msgs__msg__MovementEventList__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__MovementEventList__get_individual_type_description_source(NULL),
    ...
    sources[4] = *j2735_v2x_msgs__msg__MovementEvent__get_individual_type_description_source(NULL);
    sources[5] = *j2735_v2x_msgs__msg__MovementPhaseState__get_individual_type_description_source(NULL);
    sources[6] = *j2735_v2x_msgs__msg__SpeedConfidence__get_individual_type_description_source(NULL);
    sources[7] = *j2735_v2x_msgs__msg__TimeChangeDetails__get_individual_type_description_source(NULL);
    constructed = true;
  }
