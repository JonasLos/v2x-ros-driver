...
{
  new (message_memory) j2735_v2x_msgs::msg::SpeedLimitType(_init);
}

void SpeedLimitType_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j2735_v2x_msgs::msg::SpeedLimitType *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedLimitType_message_member_array[1] = {
  {
    ...
    offsetof(j2735_v2x_msgs::msg::SpeedLimitType, speed_limit_type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SpeedLimitType_message_members = {
  ...
  1,  // number of fields
  sizeof(j2735_v2x_msgs::msg::SpeedLimitType),
...
get_message_type_support_handle<j2735_v2x_msgs::msg::SpeedLimitType>()
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::SpeedLimitType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, SpeedLimitType)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::SpeedLimitType_message_type_support_handle;
}
