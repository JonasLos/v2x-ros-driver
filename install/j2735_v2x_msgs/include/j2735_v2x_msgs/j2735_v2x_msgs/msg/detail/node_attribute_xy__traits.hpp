...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/node_attribute_xy.hpp"
...
inline void to_flow_style_yaml(
  const NodeAttributeXY & msg,
  std::ostream & out)
{
  out << "{";
  // member: node_attribute_xy
  {
    out << "node_attribute_xy: ";
    rosidl_generator_traits::value_to_yaml(msg.node_attribute_xy, out);
  }
  out << "}";
...
inline std::string to_yaml(const NodeAttributeXY & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::NodeAttributeXY & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::NodeAttributeXY & msg)
{
