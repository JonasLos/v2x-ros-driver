...
// IWYU pragma: private, include "j2735_v2x_msgs/msg/movement_phase_state.hpp"
...
inline void to_flow_style_yaml(
  const MovementPhaseState & msg,
  std::ostream & out)
{
  out << "{";
  // member: movement_phase_state
  {
    out << "movement_phase_state: ";
    rosidl_generator_traits::value_to_yaml(msg.movement_phase_state, out);
  }
  out << "}";
...
inline std::string to_yaml(const MovementPhaseState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const j2735_v2x_msgs::msg::MovementPhaseState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const j2735_v2x_msgs::msg::MovementPhaseState & msg)
{
