...
void fetch_function__LaneDataAttributeList__lane_attribute_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const j2735_v2x_msgs::msg::LaneDataAttribute *>(
    get_const_function__LaneDataAttributeList__lane_attribute_list(untyped_member, index));
  auto & value = *reinterpret_cast<j2735_v2x_msgs::msg::LaneDataAttribute *>(untyped_value);
  value = item;
}

void assign_function__LaneDataAttributeList__lane_attribute_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<j2735_v2x_msgs::msg::LaneDataAttribute *>(
    get_function__LaneDataAttributeList__lane_attribute_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const j2735_v2x_msgs::msg::LaneDataAttribute *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LaneDataAttributeList_message_member_array[1] = {
  {
    ...
    fetch_function__LaneDataAttributeList__lane_attribute_list,  // fetch(index, &value) function pointer
    assign_function__LaneDataAttributeList__lane_attribute_list,  // assign(index, value) function pointer
