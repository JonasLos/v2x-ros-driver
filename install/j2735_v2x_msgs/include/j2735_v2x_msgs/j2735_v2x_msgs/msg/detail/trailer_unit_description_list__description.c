...
static char j2735_v2x_msgs__msg__TrailerUnitDescriptionList__FIELD_NAME__trailer_unit_descriptions[] = "trailer_unit_descriptions";

static rosidl_runtime_c__type_description__Field j2735_v2x_msgs__msg__TrailerUnitDescriptionList__FIELDS[] = {
  {
    {j2735_v2x_msgs__msg__TrailerUnitDescriptionList__FIELD_NAME__trailer_unit_descriptions, 25, 25},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription j2735_v2x_msgs__msg__TrailerUnitDescriptionList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {j2735_v2x_msgs__msg__TrailerUnitDescriptionList__FIELDS, 1, 1},
    },
    {j2735_v2x_msgs__msg__TrailerUnitDescriptionList__REFERENCED_TYPE_DESCRIPTIONS, 19, 19},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[15].fields = j2735_v2x_msgs__msg__VehicleHeight__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[16].fields = j2735_v2x_msgs__msg__VehicleLength__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[17].fields = j2735_v2x_msgs__msg__VehicleWidth__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[18].fields = j2735_v2x_msgs__msg__VertOffsetB07__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  "#\n"
  "# TrailerUnitDescriptionList.msg\n"
  "#\n"
  "# J2735 2016 message format.\n"
  "#\n"
  "\n"
  "# TrailerUnitDescriptionList ::= SEQUENCE (SIZE(1..8)) OF TrailerUnitDescription\n"
  "j2735_v2x_msgs/TrailerUnitDescription[] trailer_unit_descriptions\n"
  "\n"
  "uint8 MIN_SIZE = 1\n"
  "uint8 MAX_SIZE = 8";
...
j2735_v2x_msgs__msg__TrailerUnitDescriptionList__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *j2735_v2x_msgs__msg__TrailerUnitDescriptionList__get_individual_type_description_source(NULL),
    ...
    sources[16] = *j2735_v2x_msgs__msg__VehicleHeight__get_individual_type_description_source(NULL);
    sources[17] = *j2735_v2x_msgs__msg__VehicleLength__get_individual_type_description_source(NULL);
    sources[18] = *j2735_v2x_msgs__msg__VehicleWidth__get_individual_type_description_source(NULL);
    sources[19] = *j2735_v2x_msgs__msg__VertOffsetB07__get_individual_type_description_source(NULL);
    constructed = true;
  }
