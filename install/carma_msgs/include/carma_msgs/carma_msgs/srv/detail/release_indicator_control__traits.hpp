...
inline void to_flow_style_yaml(
  const ReleaseIndicatorControl_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: ind_list
...
inline std::string to_yaml(const ReleaseIndicatorControl_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const carma_msgs::srv::ReleaseIndicatorControl_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const carma_msgs::srv::ReleaseIndicatorControl_Request & msg)
{
...
inline void to_flow_style_yaml(
  const ReleaseIndicatorControl_Response & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const ReleaseIndicatorControl_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use carma_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const carma_msgs::srv::ReleaseIndicatorControl_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  carma_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use carma_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const carma_msgs::srv::ReleaseIndicatorControl_Response & msg)
{
  return carma_msgs::srv::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ReleaseIndicatorControl_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ReleaseIndicatorControl_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use carma_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const carma_msgs::srv::ReleaseIndicatorControl_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  carma_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use carma_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const carma_msgs::srv::ReleaseIndicatorControl_Event & msg)
{
  return carma_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<carma_msgs::srv::ReleaseIndicatorControl_Event>()
{
  return "carma_msgs::srv::ReleaseIndicatorControl_Event";
}

template<>
inline const char * name<carma_msgs::srv::ReleaseIndicatorControl_Event>()
{
  return "carma_msgs/srv/ReleaseIndicatorControl_Event";
}

template<>
struct has_fixed_size<carma_msgs::srv::ReleaseIndicatorControl_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<carma_msgs::srv::ReleaseIndicatorControl_Event>
  : std::integral_constant<bool, has_bounded_size<carma_msgs::srv::ReleaseIndicatorControl_Request>::value && has_bounded_size<carma_msgs::srv::ReleaseIndicatorControl_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<carma_msgs::srv::ReleaseIndicatorControl_Event>
  : std::true_type {};
